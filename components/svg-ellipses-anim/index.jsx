  ...
  return (
    <div ref={containerRef} className={styles.svg_container}>
        <svg ref={svgRef} viewBox="0 0 500 500" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
            ...
            <circle ref={circle1Ref} r="10" fill="#fce300" stroke="#1e1e1e" strokeWidth={desktop ? 2 : 3} />

            <circle ref={circle2Ref} r="10" fill="#fce300" stroke="#1e1e1e" strokeWidth={desktop ? 2 : 3} />
