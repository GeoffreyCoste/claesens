...
export default function StickyCursor({stickyElement}) {
  ...
  useEffect(() => {
    ...
    currentStickyElement.addEventListener('mouseenter', manageMouseOver);
    currentStickyElement.addEventListener('mouseleave', manageMouseLeave);
    window.addEventListener('mousemove', manageMouseMove);
    return () => {
      currentStickyElement.removeEventListener('mouseenter', manageMouseOver);
      currentStickyElement.removeEventListener('mouseleave', manageMouseLeave);
      window.removeEventListener('mousemove', manageMouseMove);
    };
  }, [isHovered, stickyElement, manageMouseMove]); // Include stickyElement in dependencies
