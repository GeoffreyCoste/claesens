export const services = [{
        title: "branding",
        badges: ["stratégie de marque", "identité visuelle", "logo", "charte graphique", "pictos"],
        description: [
    ...
    {
        title: "digital",
        badges: ["site web", "interfaces", "newsletters", "réseaux sociaux", "bannières"],
        description: [
            "Multipliez votre visibilité et facilitez l'interaction avec vos clients.",
    ...
    {
        title: "print",
        badges: ["papeterie", "packaging", "flyers", "brochures", "affiches"],
        description: [
            "Toucher, garder, transmettre : l'impression a cette force unique.",
    ...
    {
        title: "illustration",
        badges: ["dessins", "icônes", "personnages", "infographies", "motifs"],
        description: [
            "Sortez du lot avec des créations originales.",
    ...
    {
        title: "motion design",
        badges: ["animations", "vidéos", "GIFs", "intros", "habillages"],
        description: [
            "Captez l'attention en quelques secondes.",
